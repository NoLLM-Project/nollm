...
export function validateMetadataCoordinates(metadataRegistry, skuRegistry, spec, report) {
    ...
    for (const meta of Object.values(metadataRegistry)) {
        ...
        if (spec.metadata_coordinates.metadata_coordinates_match_sku_coordinates) {
        ...
        if (spec.metadata_coordinates.spatial_objects_require_numeric_xyz) {
        ...
        if (spec.metadata_coordinates.abstract_objects_require_null_xyz) {
